...
var PerfilEdicaoPageModule = /** @class */ (function () {
    function PerfilEdicaoPageModule() {
    }
...
var PerfilEdicaoPage = /** @class */ (function () {
    function PerfilEdicaoPage(toastController, alertCtrl, usuarioService, pacienteService, navExtra) {
    ...
    PerfilEdicaoPage.prototype.ngOnInit = function () {
        this.paciente = this.navExtra.get('paciente');
    };
    /**
     * Permite o usuário selecionar outro avatar
     */
    PerfilEdicaoPage.prototype.alterarAvatar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.alertCtrl.create({
                    ...
                    buttons: [
                        'Cancelar',
                        { text: 'Alterar', handler: function (opc) {
                                _this.paciente.avatar = opc;
                            } }
                    ]
    ...
    PerfilEdicaoPage.prototype.salvarSenha = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var msg, erro_1, toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(this.senha.length < 4)) return [3 /*break*/, 1];
                        msg = 'Crie um asenha com pelo menos 4 digitos';
                        return [3 /*break*/, 4];
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.usuarioService.atualizarSenha(this.senha)];
                    case 2:
                        _a.sent();
                    ...
                    case 3:
                        erro_1 = _a.sent();
                        if (erro_1.code == 'auth/requires-recent-login')
    ...
    PerfilEdicaoPage.prototype.salvar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var mensagem, toast;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
    ...
    PerfilEdicaoPage.ctorParameters = function () { return [
...
//# sourceMappingURL=paciente-perfil-perfil-edicao-perfil-edicao-module-es5.js.map