...
var ConquistasPage = /** @class */ (function () {
    function ConquistasPage(pacienteService, conquistaService) {
    ...
    ConquistasPage.prototype.ngOnInit = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0: return [4 /*yield*/, this.pacienteService.getPacienteLogado()];
                    case 1:
                        paciente = _c.sent();
                        _a = this;
                        return [4 /*yield*/, this.conquistaService.buscarConsquistasAlcancadas(paciente)];
                    case 2:
                        _a.conquistas = _c.sent();
                        _b = this;
                        return [4 /*yield*/, this.conquistaService.buscarConsquistasPendentes(paciente)];
                    case 3:
                        _b.conquistasNaoAlcandas = _c.sent();
                        return [2 /*return*/];
                }
            });
        });
    };
    ConquistasPage.ctorParameters = function () { return [
...
//# sourceMappingURL=conquistas-conquistas-module-es5.js.map