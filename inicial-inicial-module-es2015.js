...
let InicialPage = class InicialPage {
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().onAuthStateChanged((usuario) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
                if (usuario == null)
                    this.router.navigateByUrl('/login');
                else {
                    let nivel = yield this.usuariosService.checaNivel();
...
//# sourceMappingURL=inicial-inicial-module-es2015.js.map