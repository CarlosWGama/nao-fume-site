...
var Meta = /** @class */ (function () {
    function Meta(titulo, objetivo, usado, pacienteUID, uid) {
        if (usado === void 0) { usado = false; }
        this.titulo = titulo;
...
var FinanceiroPageModule = /** @class */ (function () {
    function FinanceiroPageModule() {
    }
...
var FinanceiroPage = /** @class */ (function () {
    function FinanceiroPage(toastController, alertController, pacienteService, financeiroService) {
    ...
    */
    FinanceiroPage.prototype.usar = function (meta) {
        var _this = this;
        ...
        this.alertController.create({
            ...
            buttons: [
                'Cancelar',
                { text: 'Usar', handler: function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    meta.usado = true;
                                    return [4 /*yield*/, this.financeiroService.atualizar(meta)];
                                case 1:
                                    _a.sent();
                                    this.atualizar();
    ...
    /** Remover uma meta */
    FinanceiroPage.prototype.remover = function (meta) {
        var _this = this;
        this.alertController.create({
            header: 'Remover meta',
            ...
            buttons: [
                'Cancelar',
                { text: 'Remover', handler: function () { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                            switch (_a.label) {
                                case 0: return [4 /*yield*/, this.financeiroService.excluir(meta)];
                                case 1:
                                    _a.sent();
                                    this.atualizar();
                                    this.toastController.create({
     ...
     */
    FinanceiroPage.prototype.adicionar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.alertController.create({
                    ...
                    buttons: [
                        ...
                        { text: 'Adicionar', cssClass: 'btn-ok', handler: function (dados) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                var meta;
                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            meta = new src_app_models_meta__WEBPACK_IMPORTED_MODULE_6__["Meta"](dados.titulo, Number(dados.objetivo));
                                            console.log(meta);
                                            return [4 /*yield*/, this.financeiroService.cadastrar(meta)];
                                        case 1:
                                            _a.sent();
                                            this.atualizar();
                                            this.toastController.create({
    ...
    FinanceiroPage.prototype.atualizar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.financeiroService.buscarTodos()];
                    case 1:
                        _a.metas = _b.sent();
                        return [2 /*return*/];
                }
    ...
    FinanceiroPage.ctorParameters = function () { return [
...
var FinanceiroService = /** @class */ (function () {
    function FinanceiroService(events) {
        var _this = this;
        this.events = events;
        firebase__WEBPACK_IMPORTED_MODULE_2__["auth"]().onAuthStateChanged(function (user) { return _this.usuario = user; });
     ...
     */
    FinanceiroService.prototype.buscarTodos = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var snapshots, metas;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.financeiroDB.where('pacienteUID', '==', this.usuario.uid).get()];
                    case 1:
                        snapshots = _a.sent();
                        metas = [];
     ...
     * @param meta
     */
    FinanceiroService.prototype.cadastrar = function (meta) {
        var doc = this.financeiroDB.doc();
     ...
     * @param meta
     */
    FinanceiroService.prototype.atualizar = function (meta) {
     ...
     * @param meta
     */
    FinanceiroService.prototype.excluir = function (meta) {
        return this.financeiroDB.doc(meta.uid).delete();
    };
    FinanceiroService.ctorParameters = function () { return [
...
//# sourceMappingURL=financeiro-financeiro-module-es5.js.map