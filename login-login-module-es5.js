...
var LoginPage = /** @class */ (function () {
    function LoginPage(router, formBuilder, toastController, usuariosService, loadingController, events) {
        this.router = router;
    ...
    LoginPage.prototype.logar = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var dados, loading, resposta;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        dados = this.form.value;
                        return [4 /*yield*/, this.loadingController.create({ message: 'Aguarde', backdropDismiss: false })];
                    case 1:
                        loading = _a.sent();
                        loading.present();
                        return [4 /*yield*/, this.usuariosService.logar(dados.codigo, dados.senha)];
                    case 2:
                        resposta = _a.sent();
                        if (resposta.sucesso) {
