...
var PacientePage = /** @class */ (function () {
    function PacientePage(router, usuariosService, questionarioService, sessaoService, modalController, pacienteService) {
        this.router = router;
    ...
    PacientePage.prototype.ionViewWillEnter = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a, dias, modal, sessoes, modalCadastro;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        // await new Promise(resolve => setTimeout(resolve, 2000));
                        _a.paciente = _b.sent();
                        return [4 /*yield*/, this.questionarioService.buscarQuestionariosAbertos()];
                    case 2:
                        dias = _b.sent();
                        if (!(dias.length > 0)) return [3 /*break*/, 5];
                        return [4 /*yield*/, this.modalController.create({
                                ...
                                componentProps: { dias: dias, sair: this.sair.bind(this) },
                    ...
                    case 4:
                        _b.sent();
                        _b.label = 5;
                    case 5: return [4 /*yield*/, this.sessaoService.buscarSessoesResponder(this.paciente)];
                    case 6:
                        sessoes = _b.sent();
                        sessoes.forEach(function (sessao) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                            var modal;
                        ...
                        if (!this.paciente.primeiroAcesso) return [3 /*break*/, 8];
                        return [4 /*yield*/, this.modalController.create({
     ...
     */
    PacientePage.prototype.setTitulo = function (page) {
        if (page == 'perfil')
            this.page = { titulo: 'Perfil', color: 'warning2' };
        if (page == 'conquistas')
     ...
     */
    PacientePage.prototype.sair = function () {
        this.usuariosService.deslogar();
        //window.location.reload();
        this.router.navigateByUrl('/login');
    };
    PacientePage.ctorParameters = function () { return [
...
//# sourceMappingURL=paciente-paciente-module-es5.js.map