 ...
 */
class Conquista {
    constructor(codigo, titulo, descricao, imagem) {
        this.codigo = codigo;
        this.titulo = titulo;
...
class ConquistaService {
     ...
     * @param paciente
     */
    buscarConsquistasAlcancadas(paciente) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const conquistasID = yield this.getConquistas(paciente.uid);
            //Recupera as alcançadas  
            const alcançadas = [];
            this.CONQUISTAS.forEach(c => { if (conquistasID.includes(c.codigo))
                alcançadas.push(c); });
            return alcançadas;
        });
    }
     ...
     * @param paciente
     */
    buscarConsquistasPendentes(paciente) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const conquistasID = yield this.getConquistas(paciente.uid);
            //Recupera as pendentes
            const pendentes = [];
            this.CONQUISTAS.forEach(c => { if (!conquistasID.includes(c.codigo))
                pendentes.push(c); });
            return pendentes;
     ...
     * @param pacienteID
     */
    getConquistas(pacienteID) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const snapConquistas = yield this.pacienteDB.doc(pacienteID).collection('conquistas').get();
            const conquistasID = [];
            snapConquistas.forEach(doc => { conquistasID.push(doc.id); });
            return conquistasID;
        });
    }
    /**
    ...
    liberarConquistas(paciente) {
        ...
        salvar.forEach(conquistaID => {
            this.pacienteDB.doc(paciente.uid).collection('conquistas').doc(conquistaID).set({ conquistado: true });
        });
    }
    /**
     ...
     * @param paciente
     */
    conquistaDiasSemFumar(paciente) {
        const salvar = [];
     ...
     * @param paciente
     */
    conquistaDiasSeguidosSemFumar(paciente) {
        const salvar = [];
...
//# sourceMappingURL=default~conquistas-conquistas-module~financeiro-financeiro-module~paciente-paciente-module~perfil-pe~50a4f5f4-es2015.js.map