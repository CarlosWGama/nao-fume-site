...
let SessaoGeralPageModule = class SessaoGeralPageModule {
};
 ...
 */
class SessaoGeralPage {
    constructor(toastController, navExtra, sessaoService, alertController) {
    ...
    salvar() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let alert = yield this.alertController.create({
                ...
                buttons: [
                    { text: 'Não solicitar', handler: () => { this.sessao.disponivel = false; } },
                    { text: 'Solicitar', handler: () => { this.sessao.disponivel = true; } },
                ]
            });
            alert.present();
...
SessaoGeralPage.ctorParameters = () => [
...
//# sourceMappingURL=geral-sessao-geral-module-es2015.js.map