...
let PacienteEntendendoFumoComponent = class PacienteEntendendoFumoComponent {
    constructor(modalController, pacienteService) {
...
PacienteEntendendoFumoComponent.ctorParameters = () => [
...
let PacienteResponderDiaComponent = 
/**
 * Modal para o Usuário responder o questionário diario
 */
class PacienteResponderDiaComponent {
    constructor(modalController, toastController, questionarioService) {
        this.modalController = modalController;
        ...
        //Dicas
        this.dicas = [
            { dica: 'Formigamento ou dormencia nos braços e pernas pode ser comum durante a abstinencia, isso ocorre por melhoramento na sua circulação sanguínea.', img: '/nao-fume-site/assets/imgs/dicas/dormente.png' },
            { dica: 'Poderá ser comum sentir-se tonto nos primeiros dias. Isso ocorre porque seu cerebro está recebendo mais oxigêncio. Esses sintomas devem desaprecer com o tempo.', img: '/nao-fume-site/assets/imgs/dicas/tonto.jpg' },
            { dica: 'Será comum nos primeiros dias tossir mais do que quando fumava. Isso ocorre devido ao fato dos cílios estarem limpado os brônquios durante o dia.', img: '/nao-fume-site/assets/imgs/dicas/tosse.jpg' },
            { dica: 'Beba muitos copos de água durante o dia. Isso irá ajudar a diminuir o desejo pelo cigarro.', img: '/nao-fume-site/assets/imgs/dicas/agua.jpg' },
            { dica: 'Sempre carregue um lanche. Ter algo para mastigar, alivia a vontade de fumar.', img: '/nao-fume-site/assets/imgs/dicas/mastigar.jpg' },
            { dica: 'Fantasie: Para relaxar, sente-se em um local calmo com pernas cruzadas, conte até 10, esqueça o ambiente e pense em apenas deixar seu corpo relaxado.', img: '/nao-fume-site/assets/imgs/dicas/fantasie.jpg' },
            { dica: 'Realize exercícios de respiração profunda. Em pé, com os pés afastados e ligeiramente dobrados, puxe o ar lentamente pelo nariz. Prenda um pouco a respiração e o libere. Repita o processo 4 vezes', img: '/nao-fume-site/assets/imgs/dicas/respire.jpg' },
            { dica: 'Pratique atividades físicas com aumento gradual. Isso ajudará a diminuir o estress, mas lembre-se de procurar um médico antes.', img: '/nao-fume-site/assets/imgs/dicas/exercicio.jpg' },
            { dica: 'Relaxe o corpo e a mente, praticando atividades tranquilas', img: '/nao-fume-site/assets/imgs/dicas/relaxamento.jpg' },
            { dica: 'Seja positivo, use frases como "eu penso...", "eu acredito...", fale com as pessoas olhando nos olhos e com vontade e disposição', img: '/nao-fume-site/assets/imgs/dicas/positivo.jpg' },
        ];
    ...
    */
    salvar() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            let toast;
            if (this.questionario.fumou == null)
                toast = yield this.toastController.create({ message: 'Informe se fumou', duration: 2000 });
            else if (this.questionario.fumou && this.questionario.cigarros == null)
                toast = yield this.toastController.create({ message: 'Preencha quantia de cigarros', duration: 2000 });
            else if (this.questionario.humor == null)
                toast = yield this.toastController.create({ message: 'Selecione o humor', duration: 2000 });
            else if (this.questionario.exercitou == null)
                toast = yield this.toastController.create({ message: 'Selecione se tem se exercitado', duration: 2000 });
            else if (this.questionario.vontadeFumar == null)
                toast = yield this.toastController.create({ message: 'Selecione a vontade de fumar', duration: 2000 });
            else {
                this.questionarioService.responder(this.questionario);
                toast = yield this.toastController.create({ message: 'Questionário salvo', duration: 2000 });
...
PacienteResponderDiaComponent.ctorParameters = () => [
    { type: _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["ModalController"] },
...
let PacienteResponderSessaoComponent = 
/**
 * Modal do paciente para responder sobre a sessão ocorrida
 */
class PacienteResponderSessaoComponent {
    constructor(sessaoService, modalController, pacienteService, toastController) {
    ...
    salvar() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            if (this.comentario == null)
                toast = yield this.toastController.create({ message: 'Informe o que achou da sessão', duration: 2000 });
            else {
                this.sessaoService.responder(this.sessao.id, this.comentario);
                toast = yield this.toastController.create({ message: 'Opinião salva', duration: 2000 });
                this.modalController.dismiss({
                    'dismissed': true
                });
            }
...
PacienteResponderSessaoComponent.ctorParameters = () => [
...
class QuestionarioService {
    constructor(pacienteService, conquistaService) {
        ...
        firebase__WEBPACK_IMPORTED_MODULE_4__["auth"]().onAuthStateChanged(user => {
            if (user != null) {
                this.pacienteService.getPacienteLogado().then(p => {
                    this.paciente = p;
                    this.pacienteDB = firebase__WEBPACK_IMPORTED_MODULE_4__["firestore"]().collection('pacientes');
                    this.questionarioDB = firebase__WEBPACK_IMPORTED_MODULE_4__["firestore"]().collection('pacientes').doc(p.uid).collection('questionariosDiarios');
                });
            }
        });
    }
    ...
    responder(questionario) {
        ...
        let cigarrosEvitados = Math.max(0, this.paciente.mediaCigarros - questionario.cigarros);
        let economizado = cigarrosEvitados * this.paciente.precoCigarro;
     ...
     */
    buscarQuestionariosAbertos() {
        let ultimoDiaRespondido = this.paciente.ultimoDiaRespondido;
        let diasResponder = [];
        let diaAtual = moment__WEBPACK_IMPORTED_MODULE_2__().format('YYYY-MM-DD');
    ...
    */
    buscarQuestionariosRespondidos() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            return yield this.questionarioDB.get().then(snapshot => {
                let questionarios = [];
...
QuestionarioService.ctorParameters = () => [
...
//# sourceMappingURL=default~financeiro-financeiro-module~paciente-paciente-module~perfil-perfil-module-es2015.js.map